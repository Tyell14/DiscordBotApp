...
module.exports = function(client, options) {
	...
	function play(msg, suffix) {
		...
		// TODO msg.author.voiceChannel is undefined
		if (msg.author.voiceChannel === null) return msg.channel.sendMessage('You\'re not in a voice channel.');
		...
		// Get the queue.
		const queue = getQueue(msg.channel.id);
